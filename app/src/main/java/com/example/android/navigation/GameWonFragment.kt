...
class GameWonFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?, inflater: MenuInflater?) {
        ...
        //Check if the share intent can be solved by some application
        //packageManager know every activity that is registered in the Manifest of every application
...
/*    private fun getShareIntent() : Intent {
        //Obtener los argumentos enviados por el anterior fragmento
